...
def app():
    ...
    st.subheader('by Jaren Joseph G. Tanque BSCS 3A, WVSU College of ICT')
    
    st.write('Dataset description:')

    st.write('Number of features: 40')
    st.write("""Simple Symbol Recognizer: Classying different shapes""")
    ...
    if st.button('Start'):
        df = pd.read_csv('shapes.csv', header=None)
